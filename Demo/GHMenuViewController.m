...
- (UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section {
	...
	if (headerText != [NSNull null]) {
		...
		gradient.colors = @[
			(id)[UIColor colorWithRed:(230.0f/255.0f) green:(152.4f/255.0f) blue:(68.5f/255.0f) alpha:1.0f].CGColor,
			(id)[UIColor colorWithRed:(230.0f/255.0f) green:(152.4f/255.0f) blue:(68.5f/255.0f) alpha:1.0f].CGColor,
		];
		...
		topLine.backgroundColor = [UIColor colorWithRed:(230.0f/255.0f) green:(152.4f/255.0f) blue:(68.5f/255.0f) alpha:1.0f];
		[headerView addSubview:topLine];
		
		UIView *bottomLine = [[UIView alloc] initWithFrame:CGRectMake(0.0f, 21.0f, [UIScreen mainScreen].bounds.size.height, 1.0f)];
		bottomLine.backgroundColor = [UIColor colorWithRed:(230.0f/255.0f) green:(152.4f/255.0f) blue:(68.5f/255.0f) alpha:1.0f];
